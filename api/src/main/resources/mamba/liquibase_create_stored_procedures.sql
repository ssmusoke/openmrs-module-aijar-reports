...
SELECT patient,
    ...
    FROM  ( select DISTINCT o.person_id as patient from obs o WHERE o.voided = 0 and concept_id=90041 and value_coded in (1065,99601) and obs_datetime<= CURRENT_DATE() and obs_datetime>= DATE_SUB(CURRENT_DATE(), INTERVAL 1 YEAR) UNION ALL
                ...
                ON e.encounter_type = et.encounter_type_id WHERE e.voided = 0 and et.uuid ='9fcfcc91-ad60-4d84-9710-11cc25258719' and encounter_datetime<= CURRENT_DATE() and encounter_datetime>= DATE_SUB(CURRENT_DATE(), INTERVAL 33 MONTH))) cohort join
