 ...
 */
@Component
public class SetupInfantDueForThirdPCR extends UgandaEMRDataExportManager {
	...
	public String getExcelDesignUuid() {
		return "c976f8e4-6dab-11ea-bc55-0242ac130003";
	}
	
	@Override
	public ReportDesign buildReportDesign(ReportDefinition reportDefinition) {
		ReportDesign rd = createExcelTemplateDesign(getExcelDesignUuid(), reportDefinition, "EIDDueForThirdPCR.xls");
	...
	public String getUuid() {
		return "7568b994-3a25-4092-a2fc-18d8ec23197f";
	}
	
	@Override
	public String getName() {
		return "Infants Due for 3rd DNA PCR";
	}
	
	@Override
	public String getDescription() {
		return "Infants List Due for 3rd DNA PCR at 6 weeks of age";
	}
	...
	private DataSetDefinition constructDataSetDefinition() {
		...
		dsd.addColumn("3rdPCRDueDate", getFirstDNAPCRDate(6, "w"), "", new CalculationResultDataConverter());
