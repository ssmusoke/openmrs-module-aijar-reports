...
public class SetUpRecencyHTSClientCardDataExportReport2019 extends UgandaEMRDataExportManager {
    ...
    private DataSetDefinition dataSetDefinition() {
        ...
        dsd.addColumn("health_unit_county", df.getPreferredAddress("stateProvince"), (String) null);
        dsd.addColumn("health_unit_sub_county", df.getPreferredAddress("address3"), (String) null);
        dsd.addColumn("health_unit_parish", df.getPreferredAddress("address4"), (String) null);
        ...
        dsd.addColumn("recency_sample_id", sdd.definition("recencySampleId", getConcept("a0a6545b-8383-4235-a74f-417db2b580f3")), "onOrAfter=${startDate},onOrBefore=${endDate}", new ObsDataConverter());
        return dsd;
    }
}
