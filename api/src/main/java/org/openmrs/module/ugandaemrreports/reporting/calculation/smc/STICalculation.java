...
public class STICalculation extends AbstractPatientCalculation {
    ...
    public CalculationResultMap evaluate(Collection<Integer> cohort, Map<String, Object> map, PatientCalculationContext context) {
        ...
        CalculationResultMap bleedingDisorderMap = Calculations.lastObs(Dictionary.getConcept("ddbcb5df-dfed-4031-b43a-7808593b1a23"), cohort, context);
        CalculationResultMap uretheralDischargeMap = Calculations.lastObs(Dictionary.getConcept("5d3a6f44-aba0-47f2-9eb6-07241243909e"), cohort, context);
        CalculationResultMap painOnUrinationMap = Calculations.lastObs(Dictionary.getConcept("c73c5f65-938b-4072-972f-5d057fb4213c"), cohort, context);
        CalculationResultMap swellingOfSrotumMap = Calculations.lastObs(Dictionary.getConcept("36b0c35e-274a-4ae7-a2dd-0f0f7d3bd25c"), cohort, context);
        CalculationResultMap otherSpecifymMap = Calculations.lastObs(Dictionary.getConcept("b8b59408-c9c7-4522-9e22-0ac79ae103a7"), cohort, context);
        CalculationResultMap genitalUlcersmMap = Calculations.lastObs(Dictionary.getConcept("ab684ea7-9ad5-4efa-9210-f324e0dd1fa6"), cohort, context);
        CalculationResultMap penileWartsmMap = Calculations.lastObs(Dictionary.getConcept("3df66d01-13ab-4d48-8aff-44699fed3765"), cohort, context);
        CalculationResultMap retractingForeSkinMap = Calculations.lastObs(Dictionary.getConcept("62b70a43-a4ce-4993-8dfb-4118f9cd9b2b"), cohort, context);
        CalculationResultMap erectileDisfunctionMap = Calculations.lastObs(Dictionary.getConcept("bc6b8019-5c3d-42ba-94b5-75e5da172a09"), cohort, context);
