...
public class SetupMER_TX_TBPatientListReport extends UgandaEMRDataExportManager {
    ...
    public String getExcelDesignUuid() {
        return "134f5bed-4544-4bba-a784-cec683ac0be1";
    }

    public String getCSVDesignUuid() {
        return "5be40c97-0f87-48ff-8445-af576b0442c1";
    }

    @Override
    public String getUuid() {
        return "9a98f32f-c9e5-42d8-bfff-81ede6161ea4";
    }

    @Override
    public String getName() {
        return "Patient List for Tx_TB MER Indicator Report";
    }
