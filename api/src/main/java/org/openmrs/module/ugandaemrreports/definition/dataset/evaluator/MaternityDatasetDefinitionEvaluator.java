...
public class MaternityDatasetDefinitionEvaluator implements DataSetEvaluator {
	...
	public DataSet evaluate(DataSetDefinition dataSetDefinition, EvaluationContext context) throws EvaluationException {
		...
		String sql = "SELECT\n" +
				...
				"   FROM encounter e\n" +
		        String.format(
		            "   WHERE YEAR(e.encounter_datetime) = %s AND MONTH(e.encounter_datetime) = %s AND e.encounter_type = 18 AND e.voided = 0) A\n",
		...
		for (Object[] r : results) {
			...
			String deliveredBy = (String) r[46];
			
			String pncAtSixMother = (String) r[42];
			
			String pncAtSixBaby = (String) r[43];
			
			String dateOfDischargeAndNameOfPersonDischarging = ((String) r[44]);
