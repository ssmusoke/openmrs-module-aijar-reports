...
import org.openmrs.module.ugandaemrreports.definition.cohort.definition.rest.MissedAppointmentCohortDefinition;
import org.springframework.beans.factory.annotation.Autowired;

import java.util.HashSet;
import java.util.List;

@Handler(supports= MissedAppointmentCohortDefinition.class, order=1)
public class MissedAppointmentCohortDefinitionEvaluator extends BaseObsCohortDefinitionEvaluator {

    @Autowired
    EvaluationService evaluationService;

    public MissedAppointmentCohortDefinitionEvaluator() { }

    public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) {
        MissedAppointmentCohortDefinition definition = (MissedAppointmentCohortDefinition) cohortDefinition;
