...
public class SetupMOH105Section3And4Report extends UgandaEMRDataExportManager {
    ...
    public ReportDesign buildReportDesign(ReportDefinition reportDefinition) {
        return createExcelTemplateDesign(getExcelDesignUuid(), reportDefinition, "HMIS_105-3-4.xls");
    }
    ...
    public String getName() {
        return "HMIS 105 - SECTION 3-4: Outreach and HCT";
    }

    @Override
    public String getDescription() {
        return "Health Unit Outpatient Monthly Report, Section 3 & 4: Outreach and HCT";
    }
