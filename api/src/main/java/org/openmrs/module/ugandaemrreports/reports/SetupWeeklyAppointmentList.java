...
/**
 * Weekly Appointments List report
 */
@Component
public class SetupWeeklyAppointmentList extends UgandaEMRDataExportManager {
    ...
    public String getExcelDesignUuid() {
        return "418c7084-dd59-11e6-bf26-cec0c932ce01";
    }

    @Override
    public String getUuid() {
        return "418c73b8-dd59-11e6-bf26-cec0c932ce01";
    }

    @Override
    public String getName() {
        return "Weekly Appointments List";
    }
    ...
    public ReportDefinition constructReportDefinition() {
        ...
        CohortDefinition definition = df.getPatientsWithObsDuringWeek(hivMetadata.getReturnVisitDate(), Arrays.asList(hivMetadata.getARTEncounterEncounterType()), BaseObsCohortDefinition.TimeModifier.ANY);
