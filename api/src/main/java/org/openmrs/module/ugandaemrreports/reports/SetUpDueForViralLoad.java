...
public class SetUpDueForViralLoad extends UgandaEMRDataExportManager {
    ...
    public ReportDefinition constructReportDefinition() {
        ...
        CohortDefinition patientsOnARTForSixMOnthsd = Cohorts.getPatientsOnARTForSixMOnths();
        CohortDefinition patientsWithViralLoad = Cohorts.getPatientsWithViralLoad();

        CohortDefinition  patientsDueForViralLoad = df.getPatientsNotIn(patientsOnARTForSixMOnthsd,patientsWithViralLoad);
