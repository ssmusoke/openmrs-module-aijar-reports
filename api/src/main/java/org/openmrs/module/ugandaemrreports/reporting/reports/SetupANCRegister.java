...
public class SetupANCRegister extends UgandaEMRDataExportManager {
    ...
    private DataSetDefinition dataSetDefinition() {
        ...
        dsd.addColumn("ANC1 Timing", definition("ANC1 Timing",  getConcept("3a862ab6-7601-4412-b626-d373c1d4a51e")), "onOrAfter=${startDate},onOrBefore=${endDate}", new ObsDataConverter());
        ...
        dsd.addColumn("FPC", definition("FPC", getConcept("0815c786-5994-49e4-aa07-28b662b0e428")), "onOrAfter=${startDate},onOrBefore=${endDate}", new ObsDataConverter());
        dsd.addColumn("TT", definition("FPC", getConcept("0815c786-5994-49e4-aa07-28b662b0e428")), "onOrAfter=${startDate},onOrBefore=${endDate}", new ObsDataConverter());
        ...
        dsd.addColumn("Free LLIN", definition("Free LLIN", getConcept("3e7bb52c-e6ae-4a0b-bce0-3b36286e8658")), "onOrAfter=${startDate},onOrBefore=${endDate}", new ObsDataConverter());
        dsd.addColumn("Mebendazole", definition("Mebendazole", getConcept("9d6abbc4-707a-4ec7-a32a-4090b1c3af87")), "onOrAfter=${startDate},onOrBefore=${endDate}", new ObsDataConverter());
        dsd.addColumn("Iron given", definition("Iron given", getConcept("315825e8-8ba4-4551-bdd1-aa4e02a36639")), "onOrAfter=${startDate},onOrBefore=${endDate}", new ObsDataConverter());
        dsd.addColumn("Folic acid given", definition("Folic acid given", getConcept("8c346216-c444-4528-a174-5139922218ed")), "onOrAfter=${startDate},onOrBefore=${endDate}", new ObsDataConverter());
        ...
        dsd.addColumn("Referal In/Out", definition("Referal In/Out", getConcept("cd27f0ac-0fd3-4f40-99a3-57742106f5fd")), "onOrAfter=${startDate},onOrBefore=${endDate}", new ObsDataConverter());
