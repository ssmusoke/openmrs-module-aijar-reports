...
public class SetupANCRegister2019 extends UgandaEMRDataExportManager {
    ...
    private DataSetDefinition dataSetDefinition() {
        ...
        dsd.addColumn("ANC Visit", sdd.definition("ANC Visit",  sdd.getConcept("c0b1b5f1-a692-49d1-9a69-ff901e07fa27")), "onOrAfter=${startDate},onOrBefore=${endDate}", new ObsDataConverter());
