...
public class SetupPNCRegister extends UgandaEMRDataExportManager {
    ...
    private DataSetDefinition dataSetDefinition() {
        ...
        dsd.addColumn("Phone Number 2", new PersonAttributeDataDefinition("Phone Number 2", phoneNumber2), "", new PersonAttributeDataConverter());
        dsd.addColumn("Phone Number 3", new PersonAttributeDataDefinition("Phone Number 3", phoneNumber3), "", new PersonAttributeDataConverter());
