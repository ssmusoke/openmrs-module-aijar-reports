        ...
        for (String patient : patients) {
            ...
            for (int i = 0; i <= 72; i++) {
                ...
                if (period <= Integer.valueOf(currentMonth)) {
                    ...
                    String inhDosage = getSummarizedObsValue(getSummarizedObs(personObs, currentMonth, "be211d29-1507-4e2e-9906-4bfeae4ddc1f"), patient);
                    String cptDosage = getSummarizedObsValue(getSummarizedObs(personObs, currentMonth, "38801143-01ac-4328-b0e1-a7b23c84c8a3"), patient);

                    SummarizedObs currentRegimen = getSummarizedObs(personObs, currentMonth, "dd2b0b4d-30ab-102d-86b0-7a5022ba4115");
                    SummarizedObs returnDate = getSummarizedObs(personObs, currentMonth, "dcac04cf-30ab-102d-86b0-7a5022ba4115");
                    ...
                    String arvDays = getSummarizedObsValue(getSummarizedObs(personObs, currentMonth, "7593ede6-6574-4326-a8a6-3d742e843659"), patient);
